...
const missile = {
	id: 'missile', // Unique command identifier
	name: ['missile'], // Command names
	description: 'THE MISSILE KNOWS WHERE IT IS AT ALL TI-', // Command description
